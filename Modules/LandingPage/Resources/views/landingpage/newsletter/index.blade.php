...
@section('page-action')
    <div data-bs-toggle="tooltip" data-bs-placement="bottom" >
        <a class="btn btn-sm btn-primary btn-icon" data-bs-toggle="modal" data-bs-original-title="{{ __('Qr Code') }}"  data-bs-target="#qrcodeModal" id="download-qr"
        target="_blanks" >
                    ...
                    <div class="row align-items-center">
                        ...
                        <div id="p1" class="col-auto text-end text-primary h3">
                            <div class="form-check form-switch custom-switch-v1">
                                ...
                                <input type="checkbox" class="form-check-input input-primary" name="joinus_status" id="joinus_status"
