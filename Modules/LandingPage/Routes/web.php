...
Route::get('faq/create/', [FaqController::class, 'faq_create'])->name('faq_create')->middleware(['auth']);
Route::post('faq/store/', [FaqController::class, 'faq_store'])->name('faq_store')->middleware(['auth']);
Route::get('faq/edit/{key}', [FaqController::class, 'faq_edit'])->name('faq_edit')->middleware(['auth']);
Route::post('faq/update/{key}', [FaqController::class, 'faq_update'])->name('faq_update')->middleware(['auth']);
Route::get('faq/delete/{key}', [FaqController::class, 'faq_delete'])->name('faq_delete')->middleware(['auth']);
...
Route::get('delete-pixel/{pixelId}', [PixelController::class, 'destoryPixel'])->name('destroy.pixel')->middleware(['auth']);
// end
