...
@php
    $path = url('/Modules/SMS/marketplace');
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
        ...
        <section class="dedicated-themes-section padding-bottom">
            <div class="container">
                <div class="section-title text-center">
                    <h2>{{ __('Effortless') }}<b>{{ __('SMS Communication') }}</b>{{ __('with BookingGo SaaS') }}</h2>
                    <p>{{ __('Explore the simplicity of reaching your audience via SMS with BookingGo SaaS. Organize, send, and track messages seamlessly through trusted gateways, ensuring reliable delivery and enhanced communication efficiency.') }}
                    </p>
                </div>
                    ...
                    <div class="col-lg-5 col-md-6 col-12">
                        <div class="abt-theme">
                            <div class="section-title">
                                ...
                                <h2>{{ __('Trusted Providers, Seamless Integration: Elevating Communication with BookingGo SaaS') }}
                                </h2>
                            </div>
                            <p>{{ __('Our platform seamlessly integrates with leading SMS gateways, providing you with unparalleled reliability and delivery assurance. Whether you prefer AWS, Twilio, Clockwork, Melipayamak, Kavenegar, or another SMS gateway provider, BookingGo SaaS has you covered. You can leverage the infrastructure of trusted providers to ensure that your messages reach their intended recipients without fail.') }}
                            </p>
                        </div>
                    </div>
                </div>
