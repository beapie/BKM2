...
@php
$path = url("/Modules/FlexibleHours/marketplace");
@endphp
@section('page-title')
{{ __('Software Details') }}
@endsection
            ...
            <div class="row row-gap align-items-center pdp-summery-row">
                <div class="col-lg-6 col-md-6 col-12 pdp-left-side">
                    <div class="pdp-summery">
                        ...
                        <p>{{__("Welcome to BookingGo's Flexible Hours Functionality, designed to give you greater control over your appointment schedule. With this feature, you can adjust your availability to better suit your needs, providing convenience for both you and your clients.")}}</p>
                        <div class="price">
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{ __('Tailored Appointment Hours') }}</h2>
                <p>{{ __("BookingGo allows you to customize your appointment hours based on your availability. Whether you prefer mornings, evenings, or weekends, you can set your schedule accordingly. Adjust your hours easily to accommodate personal commitments or peak business times.") }}
                </p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{ __('Admin-Controlled Settings') }}</h2>
                        </div>
                        <p>{{ __("The admin sets the appointment hours, ensuring consistency across the platform. You don't have to worry about managing pricing details; simply focus on managing your schedule. Whether it's peak hours or off-peak times, the admin has it covered.") }}
                        </p>
                    </div>
                </div>
            ...
            <div class="row row-gap align-items-center   padding-bottom">
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            <h2>{{__('Streamlined Setup Process')}}</h2>
                        </div>
                        <p>{{__("Setting up your flexible hours is straightforward with BookingGo. Our user-friendly interface lets you manage your schedule effortlessly. You can update your availability with ease, making it convenient to adapt to changing circumstances.")}}</p>
                    </div>
                </div>
            </div>
            <div class="row row-gap align-items-center padding-bottom ">
                            ...
                            <div class="tabs-container">
                                <div class="tab-content active" id="tab-1">
                                    <div class="pricing-content">
                                        <div class="price">
                                            <ins><span class="currency-type">{{ super_currency_format_with_sym(ModulePriceByName($module->getName())['monthly_price']) }}</span>
                                ...
                                <div class="tab-content" id="tab-2">
                                    <div class="pricing-content">
                                        <div class="price">
                                            <ins><span class="currency-type">{{ super_currency_format_with_sym(ModulePriceByName($module->getName())['yearly_price']) }}</span>
