...
$(document).ready(function () {
  ...
  /******  Nice Select  ******/
    ...
    // testimonial thumb
    var testithumbs = new Swiper ('.testimonial-thumb', {
        slidesPerView: 3,
        spaceBetween: 10,
        loop: true,
    ...
    testislider.on('slideChangeTransitionStart', function() {
      testithumbs.slideTo(testislider.activeIndex);
    });
    testithumbs.on('transitionStart', function(){
      testislider.slideTo(testithumbs.activeIndex);
    });
    // testislider.controller.control = testithumbs;
    // testithumbs.controller.control =  testislider;
