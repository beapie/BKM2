...
@php
    $path = url("/Modules/ICalExports/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('Simplify Your Schedule with BookingGo SaaS')}}</h2>
                <p>{{__('Simplify event management with BookingGo SaaS - effortlessly integrate and customize your calendar entries with our intuitive iCal module.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Seamless Integration with Your Calendar ')}}</h2>
                        </div>
                        <p>{{__("Gone are the days of manually inputting event details into your calendar. With our iCal module, adding important dates to your schedule is as simple as a few clicks. Our platform seamlessly integrates with your preferred calendar application, whether it's Google Calendar, Outlook, or any other popular platform. Once you input the event details - including date, time, location, and description - our system handles the rest, ensuring your calendar is always up to date. Say goodbye to the hassle of manual data entry and hello to effortless synchronization across all your devices.")}}</p>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Customizable Event Entries')}}</h2>
                        </div>
                        <p>{{__("We understand that every event is unique, so our iCal module offers customizable event entries to suit your specific needs. Whether you're scheduling a recurring team meeting, a one-time client appointment, or a personal milestone, our platform adapts to accommodate your requirements. Add as much or as little detail as you'd like, ensuring that all pertinent information is readily available at a glance. With customizable fields for event names, descriptions, locations, and more, you can tailor each entry to align with your workflow and preferences.")}}</p>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="bg-white padding-top padding-bottom ">
        <div class="container">
            ...
            <div class="row product-row">
                ...
                $isThemeCheck = in_array($module->getname(), get_bussiness_theme_list());
                @endphp
                ...
                <div class="col-xl-2 col-lg-4 col-md-4 col-sm-6 col-12 product-card">
                    <div class="product-card-inner">
                        ...
                        <div class="product-content">
                            ...
                            @if ($isThemeCheck)
                            <a href="https://workdo.io/bookinggo-saas-addon/" target="_new" class="btn  btn-outline-secondary w-100 mt-2">{{ __('View Details') }}</a>
                            @else
