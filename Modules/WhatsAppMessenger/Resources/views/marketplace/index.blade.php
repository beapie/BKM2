...
@php
    $path = url("/Modules/WhatsAppMessenger/marketplace");
@endphp
@section('page-title')
    {{ __('Software Details') }}
@endsection
    ...
    <section class="dedicated-themes-section padding-bottom">
        <div class="container">
            <div class="section-title text-center">
                <h2>{{__('WhatsApp Messenger')}}<b>{{__('Module in')}}</b>{{__('Bookinggo SaaS')}}</h2>
                <p>{{__('Implement the WhatsApp Messenger Module in BookingGo SaaS for efficient communication and customer engagement via WhatsApp.')}}</p>
            </div>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Effortless Communication')}}</h2>
                        </div>
                        <p>{{ __('With WhatsApp Messenger integrated into BookingGo SaaS, businesses can effortlessly connect with their clients. Instead of relying on traditional communication channels like phone calls or emails, businesses can now communicate directly with customers through WhatsApp. This eliminates the need for clients to switch between different platforms, simplifying the communication process for both parties.') }}</p>
                ...
                <div class="col-lg-5 col-md-6 col-12">
                    <div class="abt-theme">
                        <div class="section-title">
                            ...
                            <h2>{{__('Real-Time Updates')}}</h2>
                        </div>
                        <p>{{ __('One of the key benefits of WhatsApp Messenger integration is the ability to provide real-time updates to clients. Businesses can send instant notifications about booking confirmations, changes in schedules, or special offers directly to their clients\' WhatsApp inbox. This ensures that clients receive important information promptly, reducing the likelihood of missed messages or misunderstandings.') }}</p>
                    </div>
                </div>
            </div>
        </div>
