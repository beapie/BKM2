                            ...
                            @foreach ($theme_json as $json_settings)
                                @if ($json_settings['slug'] == $slug)
                                    ...
                                    <div class="card" id="settings-card">
                                        <div class="card-header">
                                            <h4>{{ $json_settings['title'] }} {{ _('Settings') }}</h4>
                                        </div>
                                        <div class="card-body">
                                                            ...
                                                            @case('image')
                                                                <div class="form-group">
                                                                    <div class="choose-files mt-3">
                                                                        ...
                                                                        : get_file($fields['value']) }}" width="100"  height="100">
                                                                    </div>
                                                                    <input type="hidden" name="slug"
                                                                        value="{{ $json_setting['key'] }}">
                                                                    {{-- <div class="form-group">
                                                                        <label>{{ $fields['label'] }}
                                                                            <small>{{ isset($fields['label']) ? '(' . $fields['size'] . ')' : '' }}</small></label>
                                                                        <div class=" input-group" data-multiple=""
                                                                            data-toggle="qxtuploader" data-type="image">
                                                                            <div class="input-group-prepend">
                                                                                <div
                                                                                    class="input-group-text bg-secondary text-dark font-weight-bold browse-btn">
                                                                                    {{ __('Browse') }}</div>
                                                                            </div>
                                                                            <div class="form-control rounded-right file-amount">
                                                                                {{ __('Choose File') }}</div>
                                                                            <input type="hidden"
                                                                                name="{{ $json_setting['key'] . '_' . $fields['key'] }}"
                                                                                class="selected-files"
                                                                                value="{{ isset($themeSetting[$json_setting['key'] . '_' . $fields['key']]) ? $themeSetting[$json_setting['key'] . '_' . $fields['key']] : '' }}">
                                                                        </div>
                                                                        <div class="file-preview sm"></div>
                                                                    </div> --}}
                                                                </div>
                                                            @break
                                                                            ...
                                                                            <div class="row align-items-center">
                                                                                <div class="col-10">
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        {{-- <label>{{ __('Image') }}
                                                                                            <small>(1920 X 770)</small></label>
                                                                                        <div class=" input-group" data-multiple=""
                                                                                            data-toggle="qxtuploader"
                                                                                            data-type="image">
                                                                                            <div class="input-group-prepend">
                                                                                                <div
                                                                                                    class="input-group-text bg-secondary text-dark font-weight-bold browse-btn">
                                                                                            ...
                                                                                            <div
                                                                                                class="form-control rounded-right file-amount">
                                                                                                {{ __('Choose File') }}</div>
                                                                                            <input type="hidden" name="image"
                                                                                                class="selected-files">
                                                                                        </div>
                                                                            ...
                                                                            <div class="row align-items-center">
                                                                                <div class="col-10">
                                                                                    ...
                                                                                    <div class="row">
                                                                                        ...
                                                                                        {{-- <div class="col-4">
                                                                                            <div class="form-group">
                                                                                                {!! Form::label('form-repeater-1-4', 'Button Link', ['class' => 'form-label']) !!}
                                                                                                {!! Form::text('button_link', null, [
                                                                                        ...
                                                                                        {{-- <div class="col-4">
                                                                                            <div class="form-group">
                                                                                                {!! Form::label('form-repeater-1-5', 'Text Align', ['class' => 'form-label']) !!}
                                                                                                {!! Form::select(
                                                                                                    'text_align',
                                                                                                    ['slide-c-l' => 'Left', 'slide-c-r' => 'Right', 'slide-c-c' => 'Center'],
                                                                                                    'slide-c-l',
                                                                                                    ['id' => 'form-repeater-1-5', 'class' => 'form-control'],
                                                                                                ) !!}
                                                                                            </div>
                                                                                        </div> --}}
                                                                                    </div>
