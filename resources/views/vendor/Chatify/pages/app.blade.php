                        ...
                        <div class="messenger-messagingView">
                            ...
                            <div class="m-header m-header-messaging">
                                <nav>
                                    ...
                                    <div style="display: inline-flex;">
                                        ...
                                        @if (!empty(Auth::user()->avatar))
                                            <div class="avatar av-s header-avatar"
                                                style="margin: 0px 10px; margin-top: -5px; margin-bottom: -5px; background-image: url('{{ get_file(Auth::user()->avatar) }}');">
                                            </div>
                                        @else
                                            <div class="avatar av-s header-avatar"
                                                style=" margin: 0px 10px; margin-top: -5px; margin-bottom: -5px;background-image: url('{{ get_file('uploads/users-avatar/avatar.png') }}');">
                                            </div>
                                        @endif
                                    ...
                                    {{-- header buttons --}}
                                    <nav class="m-header-right">
                                        <a href="#" id="image" class="add-to-favorite  "><i id="foo"
