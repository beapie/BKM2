{{Form::model($customer,array('route' => array('customer.update', $customer->id), 'method' => 'PUT', 'id' => 'business-edit-form','enctype' => 'multipart/form-data')) }}
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="choose-files ">
                        ...
                        src="{{check_file($customer->customer->avatar) ? get_file($customer->customer->avatar): get_file('uploads/default/avatar.png')}}" />
                    </div>
                </div>
            </div>
