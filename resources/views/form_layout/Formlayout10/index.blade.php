            ...
            <div class="container">
                <div class="form-wrapper">
                    <div class="section-title text-center">
                        <h2><b>{{ __('Appointment') }}</b> {{ __('Booking') }}</h2>
                    </div>
                    <div class="form-inner">
                        <div class="steps">
                            <ul>
                                <li class="stapes_status active">
                                    <span> {{ __('1. Service') }}</span>
                                </li>
                                <li class="stapes_status">
                                    <span>{{ __('2. Pick a Time') }}</span>
                                </li>
                                @if ((!empty($files) && $files->value == 'on') || (!empty($custom_field) && $custom_field == 'on'))
                                    <li class="stapes_status">
                                        <span>{{ __('3. Additional Details') }}</span>
                                    </li>
                                @endif
                                <li class="stapes_status">
                                    @if ((!empty($files) && $files->value == 'on') || (!empty($custom_field) && $custom_field == 'on'))
                                        <span>{{ __('4. Share Your Details') }}</span>
                                    @else
                                        <span>{{ __('3. Share Your Details') }}</span>
                                    @endif
                                </li>
                                <li class="stapes_status">
                                    @if ((!empty($files) && $files->value == 'on') || (!empty($custom_field) && $custom_field == 'on'))
                                        <span>{{ __('5. payment') }}</span>
                                    @else
                                        <span>{{ __('4. payment') }}</span>
                                    @endif
                                </li>
                                <li class="stapes_status">
                                    @if ((!empty($files) && $files->value == 'on') || (!empty($custom_field) && $custom_field == 'on'))
