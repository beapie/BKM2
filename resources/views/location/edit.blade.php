{{Form::model($location,array('route' => array('location.update', $location->id), 'method' => 'PUT', 'id' => 'business-edit-form','enctype' => 'multipart/form-data')) }}
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="choose-files ">
                        ...
                        src="{{check_file($location->image) ? get_file($location->image): get_file('uploads/default/avatar.png')}}" />
                    </div>
                </div>
            </div>
