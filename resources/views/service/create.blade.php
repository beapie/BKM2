{{ Form::open(['route' => ['service.store', ['business_id' => $business->id]], 'method' => 'post', 'enctype' => 'multipart/form-data']) }}
        ...
        <div class="row">
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    {{Form::number('duration',null,array('class'=>'form-control','placeholder'=>__('Enter Duration in Minute 30'),'required'=>'required','min'=>"0", 'max'=>"510"))}}
                    @error('duration')
