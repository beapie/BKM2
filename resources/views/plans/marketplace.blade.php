                        ...
                        @if (!empty($purchaseds))
                            ...
                            @foreach ($purchaseds as $purchased)
                                @php
                                    ...
                                    $json = json_decode(file_get_contents($path), true);
                                    $isThemeCheck = in_array($purchased->getname(), get_bussiness_theme_list());
                                @endphp
                                @if (!isset($json['display']) || $json['display'] == true)
                                    <div class="col-xxl-3 col-xl-4 col-lg-6 col-sm-6 product-card ">
                                            ...
                                            <div class="product-img">
                                                <div class="theme-avtar">
                                                    <img src="{{ get_module_img($purchased->getName()) }}"
                                                        alt="{{ $purchased->getName() }}" class="img-user width-100">
                                                </div>
                                                <div class="checkbox-custom">
                            ...
                            <div class="subscription-summery">
                                ...
                                <div class="summery-footer">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <li>
                                            ...
                                            <span class="cart-sum-right"><b
                                                    class="businesspricetext final_price">{{ '0.00' . $currancy_symbol }}</b></span>
                                        </li>
                                        <li>
                                            <span class="cart-sum-left">
                                                    ...
                                                    <div class="card-body p-3">
                                                        <div class="d-flex align-items-center justify-content-between">
                                                            ...
                                                            <div class="form-check">
                                                                <input class="form-check-input x" name="payment_method"
                                    ...
                                    <div
                                        ...
                                        <input type="hidden" name="business_module_price_input" value="0"
                                            class="business_module_price_input">
...
@push('scripts')
    <script>
        ...
        function SwitchChange() {
            ...
            $(".userpricetext").text(parseFloat(userpricetext).toFixed(2) + currancy_symbol);
            $(".business-price").text('( Per business ' + businessprice + currancy_symbol + ')');
            $(".businesspricetext").text(parseFloat(businesspricetext).toFixed(2) + currancy_symbol);
            ...
            $(document).on('submit', '#payment_form', function(e) {
                if ($('#bank-payment').prop('checked')) {
                    ...
                    if (file != undefined) {
                        ...
                        const fileData = $('#temp_receipt')[0].files[0];
                        formData.append('payment_receipt', fileData, fileData.name);
