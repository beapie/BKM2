...
<div class="row justify-content-center px-0">
    ...
    @if(admin_setting('custome_package') == 'on')
        <div class=" col-12">
            <div class="card">
                {{ Form::open(['url' => 'plans']) }}
                    <div class="card-body package-card-inner custome-packge-wrapper  d-flex align-items-center gap-3  justify-content-between">
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6 product-card ">
                        <div class="card {{ ($module->isEnabled()) ? 'enable_module' : 'disable_module'}}">
                            ...
                            <div class="product-content">
                                ...
                                <a href="#" target="_new" class="btn  btn-outline-secondary w-100 mt-2">{{ __('View Details')}}</a>
                            </div>
                        </div>
                    </div>
                    @endif
