                ...
                foreach ($appointments as $appointment)
                {
                    ...
                    if($appointment_date == $date && $time == $remindertime)
                    {
                        ...
                        if( (!empty($company_settings['Appointment Reminder']) && $company_settings['Appointment Reminder']  == true ))
                        {
                            ...
                            $resp = EmailTemplate::sendEmailTemplate('Appointment Reminder', [$appointment->CustomerData ? $appointment->CustomerData->customer->email : $appointment->email], $uArr,$appointment->created_by);
