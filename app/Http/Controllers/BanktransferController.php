...
class BanktransferController extends Controller
{
    ...
    public function invoicePayWithBank(Request $request)
    {
        ...
        if($invoice){
            ...
            $bank_transfer_payment->price_currency  = company_setting('defult_currancy',$invoice->created_by,$invoice->business);
            $bank_transfer_payment->created_by = $invoice->created_by;
            $bank_transfer_payment->business = $invoice->business;
            $bank_transfer_payment->save();
