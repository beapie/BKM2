...
class TestimonialController extends Controller
{
    ...
    public function store(Request $request)
    {
        if(Auth::user()->isAbleTo('testimonial create'))
        {
            $validator = \Validator::make(
                ...
                $testimonial->business_id             = getActiveBusiness();
    ...
    public function testimonialManage(Request $request,$id)
    {
        if(Auth::user()->isAbleTo('testimonial manage'))
        {
            $testimonials = Testimonial::where('business_id',getActiveBusiness())->where('created_by',creatorId())->where('theme',$id)->get();
            return view('testimonial.index',compact('id','testimonials'));
        }
        else
        {
            return redirect()->back()->with('error', __('Permission denied.'));
    ...
    public function testimonialCreate(Request $request,$id)
    {
        ...
        return view('testimonial.create',compact('id','customers'));
    }
